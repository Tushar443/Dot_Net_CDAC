...
namespace EFCode_First.Controllers
{
    public class EmployeesController : Controller
    {
        private JKMyDbContext db = new JKMyDbContext();
        ...
        public ActionResult Create([Bind(Include = "EmpNo,Name,Basic,DeptNo")] Employee employee)
        {
