...
namespace LINQ_DataSet {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("MyTypeDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class MyTypeDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected MyTypeDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            MyTypeDataSet cln = ((MyTypeDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "MyTypeDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/MyTypeDataSet.xsd";
        ...
        public partial class DepartmentsDataTable : global::System.Data.TypedTableBase<DepartmentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DepartmentsRow AddDepartmentsRow(int DeptNo, string DeptName) {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(int EmpNo, string EmpName, decimal Basic, DepartmentsRow parentDepartmentsRowByFK_Employee_ToTable) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Basic,
                        null};
                if ((parentDepartmentsRowByFK_Employee_ToTable != null)) {
                    columnValuesArray[3] = parentDepartmentsRowByFK_Employee_ToTable[0];
                }
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public DepartmentsRow DepartmentsRow {
                get {
                    return ((DepartmentsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Employee_ToTable"])));
                }
                set {
...
namespace LINQ_DataSet.MyTypeDataSetTableAdapters {
    ...
    public partial class DepartmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Departments] WHERE (([DeptNo] = @Original_DeptNo) AND ([DeptNa" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Departments] ([DeptNo], [DeptName]) VALUES (@DeptNo, @DeptName" +
                ");\r\nSELECT DeptNo, DeptName FROM Departments WHERE (DeptNo = @DeptNo)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Departments] SET [DeptNo] = @DeptNo, [DeptName] = @DeptName WHERE (" +
                "([DeptNo] = @Original_DeptNo) AND ([DeptName] = @Original_DeptName));\r\nSELECT De" +
                "ptNo, DeptName FROM Departments WHERE (DeptNo = @DeptNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LINQ_DataSet.Properties.Settings.Default.ThunderConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DeptNo, DeptName FROM dbo.Departments";
        ...
        public virtual int Fill(MyTypeDataSet.DepartmentsDataTable dataTable) {
        ...
        public virtual MyTypeDataSet.DepartmentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyTypeDataSet.DepartmentsDataTable dataTable = new MyTypeDataSet.DepartmentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyTypeDataSet.DepartmentsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyTypeDataSet dataSet) {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([EmpNo] = @Original_EmpNo) AND ([EmpName] = " +
                "@Original_EmpName) AND ([Basic] = @Original_Basic) AND ([DeptNo] = @Original_Dep" +
                "tNo))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EmpNo], [EmpName], [Basic], [DeptNo]) VALUES (@Emp" +
                "No, @EmpName, @Basic, @DeptNo);\r\nSELECT EmpNo, EmpName, Basic, DeptNo FROM Emplo" +
                "yee WHERE (EmpNo = @EmpNo)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmpNo] = @EmpNo, [EmpName] = @EmpName, [Basic] = @Basic, [DeptNo] = @DeptNo WHERE (([EmpNo] = @Original_EmpNo) AND ([EmpName] = @Original_EmpName) AND ([Basic] = @Original_Basic) AND ([DeptNo] = @Original_DeptNo));
SELECT EmpNo, EmpName, Basic, DeptNo FROM Employee WHERE (EmpNo = @EmpNo)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmpNo, EmpName, Basic, DeptNo FROM dbo.Employee";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(MyTypeDataSet.EmployeeDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual MyTypeDataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyTypeDataSet.EmployeeDataTable dataTable = new MyTypeDataSet.EmployeeDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyTypeDataSet.EmployeeDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_EmpNo, string Original_EmpName, decimal Original_Basic, int Original_DeptNo) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((decimal)(Original_Basic));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int EmpNo, string EmpName, decimal Basic, int DeptNo) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((decimal)(Basic));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int EmpNo, string EmpName, decimal Basic, int DeptNo, int Original_EmpNo, string Original_EmpName, decimal Original_Basic, int Original_DeptNo) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((decimal)(Basic));
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(Original_Basic));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EmpName, decimal Basic, int DeptNo, int Original_EmpNo, string Original_EmpName, decimal Original_Basic, int Original_DeptNo) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(MyTypeDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._departmentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(MyTypeDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._departmentsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(MyTypeDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._employeeTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(MyTypeDataSet dataSet) {
            if ((dataSet == null)) {
